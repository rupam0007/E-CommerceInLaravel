...
<div class="bg-gray-900 text-white min-h-screen">
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-6xl mx-auto">
                        ...
                        <div class="bg-gray-800 rounded-lg shadow-xl border border-gray-700 overflow-hidden">
                            <div class="p-6">
                                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4">
                                    <div>
                                        <h3 class="text-lg font-semibold text-white">Order #<span class="font-mono text-indigo-400">{{ $order->order_number }}</span></h3>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                                    <div>
                                        ...
                                        <p class="text-lg font-bold text-white font-mono">₹{{ number_format($order->total_amount, 2) }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-400">Payment Method</p>
                                        <p class="font-medium text-gray-200">{{ strtoupper($order->payment_method) }}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-200">{{ $order->orderItems->count() }} item(s)</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center space-x-4 overflow-x-auto">
                                        @foreach($order->orderItems->take(3) as $item)
                                            <div class="flex-shrink-0 flex items-center space-x-3">
                                                ...
                                                @else
                                                    <div class="w-12 h-12 bg-gray-700 rounded flex items-center justify-center border border-gray-600">
                                ...
                                <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-700">
                                    <div class="flex space-x-3">
                                        ...
                                        @if($order->status === 'delivered')
                                            <button class="inline-flex items-center px-4 py-2 border border-transparent rounded-md text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors duration-200">
                                                Write Review
                                            </button>
                                        @endif
                                    </div>
            ...
            @else
                <div class="text-center py-12 bg-gray-800 rounded-lg border border-gray-700 shadow-xl">
                    <div class="mb-4">
                    ...
                    <p class="text-gray-400 mb-6">You haven't placed any orders yet. Start shopping to see your orders here!</p>
