                    ...
                    <div class="p-6 border-b border-gray-200 last:border-b-0">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-lg font-bold text-gray-900 mt-1">₹{{ number_format($item->price, 2) }}</p>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 sticky top-4">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">₹{{ number_format($cartItems->sum('total'), 2) }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">₹{{ number_format($cartItems->sum('total') * 0.08, 2) }}</span>
                        </div>
                        <hr class="my-3">
