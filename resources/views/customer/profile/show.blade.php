                    ...
                    <div class="theme-surface rounded-2xl shadow-xl border theme-border p-6 transition-all duration-300">
                        ...
                        <form action="{{ route('profile.password.update') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="password" name="current_password" class="w-full theme-bg border theme-border rounded-lg theme-text px-4 py-2.5 focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-xs theme-text-muted uppercase font-bold mb-2">New Password</label>
                                <input type="password" name="password" class="w-full theme-bg border theme-border rounded-lg theme-text px-4 py-2.5 focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                <label class="block text-xs theme-text-muted uppercase font-bold mb-2">Confirm Password</label>
                                <input type="password" name="password_confirmation" class="w-full theme-bg border theme-border rounded-lg theme-text px-4 py-2.5 focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
